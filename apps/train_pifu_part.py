    ...
    for epoch in range(start_epoch, opt.num_epoch):
        ...
        for train_idx, train_data in enumerate(train_data_loader):
            ...
            if train_idx % opt.freq_save_ply == 0 and train_idx != 0:
                ...
                save_samples_truncated_part(save_path3, points.detach().numpy(), labels_tensor[0].cpu().numpy())
                save_samples_truncated_prob(save_path4, points.detach().numpy(), parts_tensor[0].detach().numpy())
