...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_train.add_argument('--freq_mesh', type=int, default=300)
        g_train.add_argument('--freq_eval', type=int, default=150)
        g_train.add_argument('--freq_save_ply', type=int, default=3000)
        ...
        g_train.add_argument('--save_model', type=int, default=5000)
